...
#14 Count true values in boolean array
def count_true(lst):
...
#23 Sum of numbers up to a given number
def add_up(num):
    return num * (num + 1) // 2
print(add_up(5))

#24 Sum all numbers in an array
def sum_array(arr):
    return sum(arr)
print(sum_array([1, 2, 3, 4, 5]))

#25 Get the current date in dd/mm/yy format                            #TODO and 41
...
#45 Get the day of the week from a date
from datetime import datetime
...
#46 Generate multipication table
...
#48 Get the month name from a date
import datetime
...
#57 Remove whitespace from a string
def RemoveWhitespace(str):
    return "".join(str.split())
print(RemoveWhitespace("  Hello   World  "))

#58 Convert hours to minutes
def HoursToMinutes(hours):
    return hours * 60
print(HoursToMinutes(2))

#59 Get the first n elements of an array
def FirstNElements(arr, n):
    return arr[:n]  
array = [1,2,3,4,5]
print(",".join(map(str, FirstNElements(array, 3))))

#60 Calculate the standard deviation of an array of numbers
import math
...
#79 Maximum triangle edge calculator
...
#80 Calculate the perimeter of a rectangle
def rectangle_perimeter(width, height):
    return 2 * (width + height)
print(rectangle_perimeter(5, 10))

#81 Greeting function with conditional message
...
#86 Generate an array of consecutive numbers
def consecutive_numbers(start, end):
    return list(range(start, end + 1))
result = consecutive_numbers(5, 10)
print(",".join(map(str, result)))

#87 Reverse the order of words in a sentence
...
#88 Calculate the hypotenuse of a right-angled triangle
import math
def calculate_hypotenuse(a, b):
    return math.sqrt(a ** 2 + b ** 2)
print(calculate_hypotenuse(3, 4))

#89 Count the letters in a string
def count_letters(s):
...
#90 Convert seconds to days, hours, minutes, and seconds
...
#91 World landmass proportion calculator
...
#93 Hand washing duration calculator
def wash_hands(n, nm):
...
#94 Billable days bonus calculator
...
#95 Calculate the volume of a sphere
import math
...
#96 Discounted price calculator
...
#98 Stolen items loss calculator
...
#100 Calculate the sum of even numbers in an array
...
#101 One-liner bitwise operations in python
